// Modified: 2026-09-07 09:13 — icônes d'isométrie agrandies : facteur 0.12 → 0.14 (≈47→55 pt sur
//           iPhone), bornes [44,84] inchangées — à régler à l'œil sur device (retour de Paul).
// Historique: 2026-09-02 11:03 — ajout de isometryIconSize(context) : taille partagée des icônes
...
/// barre d'état : `shortestSide × 0.14` borné [44, 84]. Sur iPhone la barre d'état plafonne à 30
/// et ces boutons paraissaient trop petits au doigt (retour de Paul) ; ici ≈ 55.
/// Appliquée en **portrait** ; le paysage garde ses rails compacts. **À régler à l'œil sur device.**
double isometryIconSize(BuildContext context) =>
    (MediaQuery.of(context).size.shortestSide * 0.14).clamp(44.0, 84.0);
